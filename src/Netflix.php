...
class Netflix extends Webrequests
{
    private $_LOGIN_URL = "https://www.netflix.com/Login";
    private $_LOGOUT_URL = "https://www.netflix.com/SignOut";
    private $_PROFILE_URL = "https://www.netflix.com/YourAccount";
    ...
    private static $_SERVICE = "netflix";
     ...
     * @return $this
     */
    public function save($file = "results_netflix.txt")
    {
